...
$backendCmd = "cd '$PSScriptRoot\vibe-backend'; npm.cmd run dev"
$frontendCmd = "cd '$PSScriptRoot\vibe-frontend'; npm.cmd start"
$mcpCmd = "cd '$PSScriptRoot\stitch-mcp-server'; npm.cmd run inspector"
...
Write-Host "Starting Vibe Frontend on port 3000..." -ForegroundColor Yellow
