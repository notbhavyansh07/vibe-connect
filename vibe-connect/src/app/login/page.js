            ...
            <div className="container max-w-md w-full p-6">
                <div className="glass p-8 rounded-2xl border border-white/10 shadow-2xl relative">
                    ...
                    <div className="text-center mt-8 mb-8">
                        ...
                        <p className="text-gray-400">Log in to reconnect with your vibe.</p>
                    </div>

                    <form onSubmit={handleLogin} className="space-y-4">
                        {registered && (
                            <div className="bg-emerald-500/10 border border-emerald-500/50 text-emerald-400 text-xs p-3 rounded-xl text-center mb-4">
                                Registration successful! Please log in.
                            </div>
                        )}
                        {error && (
                            <div className="bg-red-500/10 border border-red-500/50 text-red-500 text-xs p-3 rounded-xl text-center mb-4">
                                {error}
                            </div>
                        )}
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-surface/50 border border-white/10 rounded-xl px-10 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/50 transition-all"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <button
                            type="submit"
                            className="btn btn-primary w-full justify-center py-3 mt-6 text-lg bg-gradient-to-r from-accent to-secondary disabled:opacity-50 disabled:cursor-not-allowed"
                            disabled={loading}
                        >
                            {loading ? "Vibing in..." : (
                        ...
                        <button
                            type="button"
                            onClick={fillDemo}
                            className="w-full text-xs text-center text-gray-500 hover:text-accent transition-colors mt-2"
                        >
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-gray-400 text-sm">
                            New to VibeConnect?{' '}
                            <Link href="/signup" className="text-accent hover:text-accent-glow font-medium transition-colors">
                                Sign Up
                            </Link>
                        </p>
                    </div>
